...
case class Player(
  ...
  var strength: Int = stats.head
  stats = stats.tail
  var dexterity: Int = stats.head
  stats = stats.tail
  var constitution: Int = stats.head
  stats = stats.tail
  var intelligence: Int = stats.head
  stats = stats.tail
  var wisdom: Int = stats.head
  stats = stats.tail
  var charisma: Int = stats.head
  var baseAC = 10
